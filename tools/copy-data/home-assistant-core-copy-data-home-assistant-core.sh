...
# bash -c "$(curl -fsSL https://raw.githubusercontent.com/vinceTheProgrammer/ProxmoxVE-ottersnap-psql-patchmainmain/tools/copy-data//home-assistant-core-copy-data-home-assistant-core.sh)"
