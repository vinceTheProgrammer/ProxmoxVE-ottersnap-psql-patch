...
service:
  ...
  vinceTheProgrammer/ProxmoxVE-ottersnap-psql-patch:
    latest_version:
      type: github
      url: vinceTheProgrammer/ProxmoxVE-ottersnap-psql-patch
      use_prerelease: false
    dashboard:
      icon: https://raw.githubusercontent.com/vinceTheProgrammer/ProxmoxVE-ottersnap-psql-patch/refs/heads/main/misc/images/logo.png
      icon_link_to: https://community-scripts.org/
      web_url: https://github.com/vinceTheProgrammer/ProxmoxVE-ottersnap-psql-patch/releases
EOF
msg_ok "Setup Config"
