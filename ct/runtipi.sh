...
ADDON_SCRIPT="https://raw.githubusercontent.com/vinceTheProgrammer/ProxmoxVE-ottersnap-psql-patchmain/tools/addon/runtipi.sh"
...
bash -c "$(curl -fsSL https://raw.githubusercontent.com/vinceTheProgrammer/ProxmoxVE-ottersnap-psql-patchmain/tools/addon/runtipi.sh)"
MIGRATION_EOF
