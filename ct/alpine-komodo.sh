...
ADDON_SCRIPT="https://raw.githubusercontent.com/vinceTheProgrammer/ProxmoxVE-ottersnap-psql-patchmain/tools/addon/komodo.sh"
...
bash -c "$(curl -fsSL https://raw.githubusercontent.com/vinceTheProgrammer/ProxmoxVE-ottersnap-psql-patchmain/tools/addon/komodo.sh)"
MIGRATION_EOF
